...
- **Filenames** — parse the naming convention (e.g., `01_alignment_faking_hubinger_2024.pdf` → title words: alignment faking, author: hubinger, year: 2024)
...
- Blog posts from major research labs (e.g., Anthropic, OpenAI, DeepSeek, Google DeepMind, Meta FAIR, etc.)
...
2. **Build the filename** using this convention:
   ...
   Example: `01_alignment_faking_in_llms_hubinger_2024.pdf`
...
4. **Report results**: After all downloads, summarize what was staged:
   ```
   ## Staged Papers
   - staging-area/01_alignment_faking_in_llms_hubinger_2024.pdf ✓
   - staging-area/02_power_seeking_tendencies_turner_2021.pdf ✓
